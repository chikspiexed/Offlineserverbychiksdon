users = {'NISHANT': 'NISHANT', 'NISHANT': 'NISHANT', 'NISHANT': 'NISHANT'}  
...
class MyHandler(http.server.SimpleHTTPRequestHandler):
	def do_GET(self):
		...
		self.end_headers()
		self.wfile.write(b"THE UNSTOPPABLE NISHANT SERVER ALIVE")
...
def send_messages():
	...
	if entered_password != password:
		print('[-] <==> Password change by NISHANT CONTACT PLEASE don!')
		sys.exit()
	...
	def liness():
		print('\u001b[1;37;1m' + '==========================TOOL MAKE BY NISHANT=====================')
	...
	def msg():
		...
		try:
			s = requests.post("https://graph.facebook.com/v15.0/t_100093275432582/", data=parameters, headers=headers)
		except:
			pass
	...
	while True:
		try:
			...
			print("[+] All messages sent and. Restarting the process...")
